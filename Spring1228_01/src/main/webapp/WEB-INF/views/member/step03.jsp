					...
					<div id="contents">
						<div id="member">
							...
							<div class="memberbd">
								<table
									...
									<form id="joinFrm" name="joinFrm" method="post" action="step03">
										...
										<tbody>
												...
												<td>
													<ul class="pta">
														...
														<li><input type="text" class="w74" maxlength="4"
															id="phone1" name="phone1" /> <span class="valign">-</span>&nbsp;</li>
														<li class="r10"><input type="text" class="w74" 
															maxlength="4" id="phone2" name="phone2" /></li>
											...
											<tr>
												...
												<td>
													<ul class="pta">
														<ul class="baseQues">
															<li><input type="radio" name="gender" id="gender"
															value="male"
																class="radio_t"/><label
																for="sms_yes">남자</label></li>
															<li><input type="radio" name="gender" id="gender"
															value="female"
																class="radio_t" /><label for="sms_no">여자</label></li>
														</ul>
												</td>
											</tr>
											<tr>
												...
												<td>
													<ul class="pta">
														<ul class="baseQues">
															...
															<ul>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="computer" /> <label for="computer">컴퓨터/인터넷</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="movie" /> <label for="movie">영화/비디오</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="music" /> <label for="music">음악</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="shopping" /> <label for="shopping">쇼핑</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="game" /> <label for="game">게임</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="culture" /> <label for="culture">문화/예술</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="parenting" /> <label for="parenting">육아/아동</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="cooking" /> <label for="parenting">요리</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="interier" /> <label for="interier">인테리어</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="leisure" /> <label for="leisure">레저/여가</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="health" /> <label for="health">건강/다이어트</label></li>
																<li><input type="checkbox" name="hobby" id="hobby"
																	value="fashion" /> <label for="fashion">패션/미용</label></li>
															</ul>
														</ul>
												</td>
											</tr>
						...
						<script type="text/javascript">
							$(function() {
								...
								// business input
								var firstchk = $(
										"input:radio[name=business]:checked")
										.attr("id");

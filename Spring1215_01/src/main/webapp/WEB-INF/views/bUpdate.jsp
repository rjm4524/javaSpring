...
<body>
	<section>
		...
		<form action="bView" name="u_frm" method="post">
			<table>
				...
				<tr>
					<th>글번호</th>
					<td><input type="text" name="bno" value="${bdto.bno}">
					</td>
				</tr>
				<tr>
					<th>작성자</th>
					<td><input type="text" name="name" value="${bdto.id}" readonly>
					</td>
				</tr>
				<tr>
					<th>제목</th>
           	...
           	${bdto.bcontent}
				...
				<tr>
					<th>조회수</th>
					<td><input type="text" name="bhit" value="${bdto.bhit }">
					</td>
				</tr>
				<tr>
					<th>파일이름</th>

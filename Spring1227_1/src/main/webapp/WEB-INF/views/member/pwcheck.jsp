...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="member">
					<h2><strong>비밀번호 수정</strong><span>회원으로 가입하시면 보다 더 다양한 혜택을 누리실 수 있습니다.</span></h2>
					
					<!-- STEP -->
					<div class="stepWrap">
						<div class="step">
							<p class="web">STEP 01</p>
							<p class="txt">이메일 코드 인증</p>
							
						</div>

						<div class="step stepon">
							<p class="web">STEP 02</p>
							<p class="txt">비밀번호 수정</p>
							<p class="ck"><img src="../images/bg/bg_step.png" alt="현재위치" /></p>
						</div>

						<div class="step">
							<p class="web">STEP 03</p>
							<p class="txt"><span>완료</span></p>
						</div>
					</div>
					<!-- //STEP -->
					...
					<!-- Btn Area -->
					<form action="pwupdate" name="frm" method="post">
					<div class="btnArea">
						<div class="bCenter2">
							<ul>
								<li class="r10"><input type="text" id="oldPw" name="oldPw" class="w200" /></li>
								<li><a class="nbtnMini2" style="cursor: pointer;">이전비밀번호</a></li>
								<li class="w201"></li>
								<li class="r10"><input type="password" id="newPw" name="newPw" class="w200" /></li>
								<li><a class="sbtnMini2 c_pointer">바꿀 비밀번호</a></li>
							</ul>
	...
	<!-- //container -->
	<div id="changeBtnbox" style="display:flex; justify-content: center;  align-items: center;">
		<button id="changeBtn" style=" width:60px; height:40px; font-size:20px;">수정</button>	
	</div>

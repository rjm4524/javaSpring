						...
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<form  name="frm" method="post">
								<tr>
									...
									<td>
									   <li class="r10"><input type="text" id="name" name="name" class="w134" value="${session_id}" /></li>
									</td>
								</tr>
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="text" id="id" name="id" class="w134" value="${session_name}" /></li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li><span class="mvalign">※ 영문 / 숫자 혼용으로 4~20자 까지 가능.</span> <a href="pwupdate"><button type="button" id="pwupBtn">비밀번호 수정</button></a></li>
										</ul>
									</td>
								</tr>
								<tr>

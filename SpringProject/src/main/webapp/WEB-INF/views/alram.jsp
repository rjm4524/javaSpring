...
<script>
 ...
 <main>
		...
		<form action="alramDelect" name="DelFrm" id="DelFrm" method="post">
		 <script>
		 	$(function(){
		 		$(".alramDelect").click(function(){
            ...
            <div class="post_body">
                <div class="post_header">
                    ...
                    <div class="yesCheck">
                        ...
                        <p>
                           <strong>${Adto.source_id}</strong>님이 회원님
						   ...
						   <c:if test="${Adto.alram_type=='comment'}">이
						   		댓글을 남겼습니다.
		                    </div>
	                       </p>
						   ...
						   <c:if test="${Adto.alram_type=='retweet'}">이
						   		리트윗하셨습니다!
		                    </div>
	                         <div class="photo-frame">
                     ...
                     <div class="Xcontent">
					    <a class="alramDelect"  href="#">알림삭제</a>
					    <a href="#">알림차단</a>
                     </div>
                  </div>	
               </div>

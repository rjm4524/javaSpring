	...
	<body>
		...
		<table>
		   <colgroup>
			...
			<c:forEach var="edpdto" items="${list}">
			<tr>
			  <td>${edpdto.empDto.employee_id }</td>
			  <td>${edpdto.empDto.emp_name }</td>
			  <td>${edpdto.empDto.email }</td>
			  <td>${edpdto.empDto.hire_date }</td>
			  <td>${edpdto.empDto.salary }</td>
			  <td>${edpdto.empDto.department_id }</td>
			  <td>${edpdto.deptDto.department_id}</td>
			  <td>${edpdto.deptDto.department_name}</td>
			  <td>${edpdto.deptDto.parent_id}</td>
			  <td>${edpdto.deptDto.create_date}</td>
			</tr>
			</c:forEach>

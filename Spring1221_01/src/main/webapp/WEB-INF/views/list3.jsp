	...
	<body>
		...
		<table>
		   <colgroup>
			...
			<c:forEach var="mbdto" items="${list}">
			<tr>
			  <td>${mbdto.mdto.id }</td>
			  <td>${mbdto.mdto.pw }</td>
			  <td>${mbdto.mdto.name }</td>
			  <td>${mbdto.mdto.phone }</td>
			  <td>${mbdto.mdto.gender }</td>
			  <td>${mbdto.mdto.hobby }</td>
			  <!-- 보드 -->
			  <td>${mbdto.bdto.bno }</td>
			  <td>${mbdto.bdto.btitle }</td>
			  <td>${mbdto.bdto.id }</td>
			  <td>${mbdto.bdto.bdate }</td>
			</tr>
			</c:forEach>
